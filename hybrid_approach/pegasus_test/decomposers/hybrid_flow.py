...
# logging
RESULT_FILENAME = "hybrid_flow_results.log"
...
# Define the workflow
iteration = hybrid.EnergyImpactDecomposer(size=10) | hybrid.QPUSubproblemAutoEmbeddingSampler(num_reads=500) | hybrid.SplatComposer()
