...
for S in [10]:
    ...
    for P in [8]:
        ...
        cs = cs_large/4.0
        results_file = open("auto_embedding_size_8_1.txt", "a+")

        sampling_result = EmbeddingComposite(DWaveSampler(solver='DW_2000Q_6')).sample_qubo(Q, num_reads=2000,
        ...
        if check_gaps:
            ...
            for i in range(int(gaps)):
                ...
                while samples_index != len(list_sampling_result) \
                    ...
                    counter += list_sampling_result[samples_index].num_occurrences
                    samples_index += 1
