...
# logging
RESULT_FILENAME = "hybrid_flow_results_postprocessing_size15_subproblem10_4.log"
...
sampling_params = {"auto_scale": True, "annealing_time": 8, "postprocess": "optimization"}
...
# Define the workflow
iteration = hybrid.EnergyImpactDecomposer(size=subproblem_size) | \
            hybrid.QPUSubproblemAutoEmbeddingSampler(qpu_sampler=DWaveSampler(solver='DW_2000Q_6', sampling_params=sampling_params), num_reads=500) | \
